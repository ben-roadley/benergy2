...
class CatalogExercisedefinition(SQLModel, table=True):
    ...
    __table_args__ = (
        ...
        Index(
            "catalog_exercisedefinition_slug_b82a0043_like",
            "slug",
    ...
    primary_muscles: dict = Field(
        sa_column=Column("primary_muscles", JSONB, nullable=False)
    )
    secondary_muscles: dict = Field(
        sa_column=Column("secondary_muscles", JSONB, nullable=False)
    )
    ...
    mechanic: Optional[str] = Field(
        default=None, sa_column=Column("mechanic", String(20))
    )
    equipment: Optional[str] = Field(
        default=None, sa_column=Column("equipment", String(50))
    )
